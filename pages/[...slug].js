export default async function handler(req, res) {
    // This root catch-all route handles resources that "leaked" out of the proxy
    // and are being requested relative to the root / on localhost.
    ...
    // We assume the request path relative to root maps to the origin root
    ...
    try {
        ...
        console.error('Root catch-all proxy error:', e);
