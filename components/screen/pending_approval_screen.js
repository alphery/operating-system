...
export default function PendingApprovalScreen() {
    ...
    return (
        <div className="w-screen h-screen flex items-center justify-center bg-[#050505] relative overflow-hidden font-sans selection:bg-purple-500/30">
            ...
            {/* --- MAIN CARD --- */}
            <div className="relative z-10 max-w-lg w-full mx-4 group">
                ...
                <div className="relative bg-black/40 backdrop-blur-3xl rounded-[2rem] shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] border border-white/10 overflow-hidden">
                    {/* Interior Header Decor */}
                    <div className="h-2 w-full bg-gradient-to-r from-transparent via-purple-500/50 to-transparent"></div>
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        <div className="flex flex-col items-center text-center mb-10">
                            <div className="relative mb-8">
                                ...
                                <div className="w-24 h-24 bg-gradient-to-b from-white/10 to-transparent rounded-full flex items-center justify-center border border-white/20 shadow-inner group-hover:scale-105 transition-transform duration-500">
                                    <svg className="w-10 h-10 text-purple-400 drop-shadow-[0_0_10px_rgba(168,85,247,0.5)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                                    </svg>
                                </div>

                                {/* Floating Badge */}
                                <div className="absolute -bottom-2 -right-2 bg-purple-600 text-white p-2 rounded-xl shadow-lg animate-bounce">
                        ...
                        {/* User Identity Panel */}
                        {userData && (
                            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-5 mb-8 flex items-center gap-5 hover:bg-white/[0.05] transition-colors">
                                <div className="relative">
                                    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-purple-500 to-blue-600 flex items-center justify-center p-[2px]">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-white font-bold text-lg truncate">{userData.displayName || 'Guest User'}</p>
                                    <p className="text-gray-500 text-sm truncate uppercase tracking-widest">{userData.email}</p>
                                </div>
                            </div>
                        )}

                        {/* Status Message */}
                        <div className="bg-gradient-to-br from-purple-500/10 to-transparent border border-purple-500/20 rounded-2xl p-6 mb-10">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="text-purple-300 font-bold mb-1">Verification Required</h4>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <button
                                ...
                                className="group relative py-4 px-6 bg-white text-black rounded-2xl font-bold flex items-center justify-center gap-3 active:scale-[0.98] transition-all hover:bg-gray-200 shadow-[0_0_20px_rgba(255,255,255,0.1)] overflow-hidden"
                            >
                            ...
                            <button
                                onClick={logout}
                                className="group py-4 px-6 bg-transparent border border-white/20 text-white rounded-2xl font-bold flex items-center justify-center gap-3 hover:bg-white/10 hover:border-white/40 transition-all active:scale-[0.98]"
                            >
                    ...
                    {/* Bottom Status Bar */}
                    <div className="bg-white/[0.02] border-t border-white/5 py-6 px-8 flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            <div className="relative w-3 h-3">
                                <div className="absolute inset-0 bg-purple-500 rounded-full animate-ping opacity-75"></div>
                                <div className="relative bg-purple-600 w-3 h-3 rounded-full"></div>
                            </div>
                            <span className="text-gray-500 text-xs font-bold uppercase tracking-tighter">System is Online</span>
                        </div>
                        <div className="text-gray-500 text-[10px] font-medium tracking-[0.2em] uppercase">
                            Alphery Access v2.0
                        </div>
                    </div>
                </div>
