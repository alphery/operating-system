            ...
            <div className="w-full max-w-md p-8 space-y-6">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-6xl font-black tracking-tight mb-2">
                        ...
                        <span className="ml-3 bg-gradient-to-r from-blue-500 via-purple-600 to-blue-500 text-transparent bg-clip-text">
                            OS
                        </span>
                    </h1>
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full py-3 bg-white text-gray-900 font-semibold rounded-lg hover:bg-gray-100 transition-colors flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <div className="text-center pt-4 border-t border-gray-800">
                    <p className="text-xs text-gray-500 mb-2">Or try demo mode (local storage)</p>
                    <button
