module.exports = {
  ...
  theme: {
    backgroundColor: theme => ({
      ...theme('colors'),
      'ub-grey': 'var(--bg-primary, #111111)',
      'ub-warm-grey': "#AEA79F",
      'ub-cool-grey': 'var(--bg-secondary, #333333)',
      'ub-orange': 'var(--accent-color, #E95420)',
      'ub-lite-abrgn': "#77216F",
      'ub-med-abrgn': "#5E2750",
      'ub-drk-abrgn': "#2C001E",
      'ub-window-title': 'var(--bg-primary, #201f1f)',
      'ub-title-bar': 'var(--bg-primary, #201f1f)',
    ...
    textColor: theme => ({
      ...
      'ubt-cool-grey': 'var(--text-secondary, #333333)',
      'ubt-blue': "#3465A4",
      'ubt-green': "#4E9A06",
